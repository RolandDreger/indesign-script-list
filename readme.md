...
### [Add bookmarks](https://github.com/RolandDreger/indesign-add-bookmarks)
Create bookmarks in an Adobe InDesign document using paragraph styles, character styles, or a GREP search. 
